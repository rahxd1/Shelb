...
Partial Public Class ReporteCatalogacionCategoriaNR
    ...
    Dim Campos(200), Columnas(200) As String
        ...
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            Else
                SQL = "SELECT H.nombre_region as 'Región', H.ciudad as 'Ciudad',H.id_usuario as 'Promotor', " & _
                        ...
                        "INNER JOIN (SELECT folio_historial,id_producto,catalogado " & _
                        "FROM NR_Historial_Inventarios_Det as H) PVT " & _
                        "PIVOT(SUM(catalogado) FOR id_producto  " & _
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Reporte catalogación por tienda " + cmbPeriodo.SelectedItem.ToString + ".xls")
