<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteAnaquelCategoriaNR.aspx.vb" 
    Inherits="procomlcd.ReporteAnaquelCategoriaNR"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
                        Reporte participación en anaquel por categoria</div>
                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" Width="645px" 
                                ...
                                <Columns>  
                                    <asp:BoundField HeaderText="Categoria" DataField="nombre_tipo"/> 
                                    <asp:BoundField HeaderText="Newell Rubbermaid" DataField="NR"/>
