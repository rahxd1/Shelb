...
Partial Public Class RutasPromotorNR
    ...
    Private Sub PeriodoActual()
        Dim Tabla As DataTable = Tablas.Ver.DT(ConexionBerol.localSqlServer, _
                                               "SELECT * FROM NR_Periodos ORDER BY id_periodo DESC")
    ...
    Sub SQLCombo()
        ...
        PromotorSQL = "SELECT DISTINCT id_usuario FROM View_NR_Rutas_Eventos " & _
                    " " + RegionSel + " " & _
                    "ORDER BY id_usuario"
    End Sub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If Tipo_usuario = 1 Then
                ...
                Combo.LlenaDrop(ConexionBerol.localSqlServer, "SELECT TOP 4 * " & _
                                "FROM NR_Periodos " & _
    ...
    Sub CargarRuta()
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionBerol.localSqlServer, _
                        "execute NR_Cargar_Ruta_Promotor " & cmbPeriodo.SelectedValue & ",'" & Usuario & "'", _
                        gridRutas)
        End If
    End Sub
