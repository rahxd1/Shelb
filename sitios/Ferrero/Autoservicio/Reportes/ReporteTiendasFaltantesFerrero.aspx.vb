...
Partial Public Class ReporteTiendasFaltantesFerrero
    ...
    Sub CargarReporte()
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionFerrero.localSqlServer, _
                        "select distinct REG.nombre_region,H.id_usuario,CAD.nombre_cadena,H.nombre_tienda " & _
                        ...
                        "ORDER BY REG.nombre_region,H.id_usuario,CAD.nombre_cadena,H.nombre_tienda ", Me.gridReporte)
        End If
    End Sub
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Reporte Tiendas con faltantes " + cmbPeriodo.SelectedItem.ToString + ".xls")
