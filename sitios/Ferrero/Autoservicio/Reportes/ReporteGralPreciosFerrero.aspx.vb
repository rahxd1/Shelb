...
Partial Public Class ReporteGralPreciosFerrero
    ...
    Sub CargarReporte()
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionFerrero.localSqlServer, _
                        ...
                        "HDET.id_producto,HDET.precio " & _
                        ...
                        "WHERE H.id_periodo = " & cmbPeriodo.SelectedValue & " AND precio <> 0" & _
                        " " + RegionSQL + " " & _
                        " " + PromotorSQL + " " & _
                        " " + CadenaSQL + ") AS Datos PIVOT(SUM(precio) " & _
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Reporte Precios general" + cmbPeriodo.SelectedItem.ToString + ".xls")
        ...
        If e.Row.RowType = DataControlRowType.DataRow Then
            For i = 4 To 77
                If e.Row.Cells(i).Text <> "&nbsp;" Then
                    e.Row.Cells(i).Text = FormatCurrency(e.Row.Cells(i).Text, 2)
                End If
            Next i
        End If
    End Sub
