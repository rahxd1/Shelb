...
Partial Public Class ReportePreciosFerrero
    ...
    Sub CargarReporte()
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionFerrero.localSqlServer, _
                        "select H.id_periodo,MAR.id_marca, MAR.nombre_marca, CAT.nombre_categoria, PROD.id_producto,PROD.presentacion, PROd.gramaje,PROD.nombre_producto, " & _
                        ...
                        "AND HDET.precio<>0 " + RegionSQL + PromotorSQL + CadenaSQL + " " & _
                        "GROUP BY H.id_periodo,MAR.id_marca,MAR.nombre_marca, CAT.nombre_categoria, PROD.id_producto, PROD.presentacion, PROd.gramaje,PROD.nombre_producto " & _
                        "ORDER BY MAR.id_marca", Me.gridReporte)
        End If
    End Sub
