<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteFaltantesFerrero.aspx.vb" 
    Inherits="procomlcd.ReporteFaltantesFerrero" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoFerreroAS" runat="Server">
    ...
    <!--titulo-pagina-->
        <div id="titulo-pagina">
                        Reporte cantidad de tiendas con faltantes por productos</div>
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                            Width="100%" ShowFooter="True" CssClass="grid-view">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Tiendas" DataField="faltante"/>  
                                </Columns>   
