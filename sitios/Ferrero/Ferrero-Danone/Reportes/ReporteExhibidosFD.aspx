<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteExhibidosFD.aspx.vb" 
    Inherits="procomlcd.ReporteExhibidosFD" 
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" Height="350px" ScrollBars="Both">
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="con Exhibiciones" DataField="2"/> 
                                <asp:BoundField HeaderText="" DataField="2A"/> 
                                <asp:BoundField HeaderText="" DataField="2B"/> 
                                <asp:BoundField HeaderText="" DataField="2C"/> 
                            </Columns>   
