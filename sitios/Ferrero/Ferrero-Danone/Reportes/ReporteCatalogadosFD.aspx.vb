...
Partial Public Class ReporteCatalogadosFD
    ...
    Sub CargaGrafica()
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            Dim Tabla As DataTable = Tablas.Ver.DT(ConexionFerrero.localSqlServer, _
                                                   "select PROD.nombre_producto, sum(HDET.catalogado) as cantidad " & _
                            ...
                            "WHERE H.id_periodo = " & cmbPeriodo.SelectedValue & " And HDET.catalogado = 1 " & _
                            " " + RegionSQL + " " & _
                            " " + PromotorSQL + " " & _
                            " " + ColoniaSQL + " " & _
            ...
            strXML.Append("<chart caption='Tiendas con productos catalogados' yAxisMaxValue='" & Tiendas + 5 & "' showborder='0' bgcolor='FFFFFF' bgalpha='100' rotateLabels='1'  placeValuesInside='1' rotateValues='1' >")
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Reporte Productos Catalogados por tienda " + cmbPeriodo.SelectedItem.ToString + ".xls")
