<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteVisitaFD.aspx.vb" 
    Inherits="procomlcd.ReporteVisitaFD" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentFerreroDanone" runat="Server">
    ...
    <!--titulo-pagina-->
        <div id="titulo-pagina">
                        Reporte frecuencia de visita</div>
        ...
        <div id="content-main-two-column">
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Label ID="lblTiendas" runat="server" Font-Bold="True" />
                    tiendas levantadas
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" Height="350px" ScrollBars="Both">
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Frecuencia de visita" DataField="4"/> 
                            </Columns>   
