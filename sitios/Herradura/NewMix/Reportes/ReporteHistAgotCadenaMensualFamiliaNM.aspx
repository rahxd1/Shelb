<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteHistAgotCadenaMensualFamiliaNM.aspx.vb" 
    Inherits="procomlcd.ReporteHistAgotCadenaMensualFamiliaNM"
        ...
        <div id="content-main-two-column">
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="PanelFS1" runat="server"/>
                    <asp:Panel ID="PanelFS2" runat="server"/>
                    <asp:Panel ID="PanelFS3" runat="server"/>
                    <asp:Panel ID="PanelFS4" runat="server"/>
                    <asp:Panel ID="PanelFS5" runat="server"/>
