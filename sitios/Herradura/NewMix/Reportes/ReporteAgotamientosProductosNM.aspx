<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteAgotamientosProductosNM.aspx.vb" 
    Inherits="procomlcd.ReporteAgotamientosProductosNM" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderNewMix" runat="Server">
    ...
    <!--titulo-pagina-->
        <div id="titulo-pagina">
                        Reporte agotamientos por producto</div>
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both" Height="350px">   
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                 ...
                                 <asp:BoundField DataField="Agotamientos" HeaderText="Agotamiento" />
                                 <asp:BoundField DataField="Catalagados" HeaderText="Catalogados" />
