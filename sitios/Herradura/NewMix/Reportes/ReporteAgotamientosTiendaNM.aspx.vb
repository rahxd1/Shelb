...
Partial Public Class ReporteAgotamientosTiendaNM
        ...
        If cmbPeriodo1.SelectedValue <> "" And cmbPeriodo2.SelectedValue <> "" Then
            ...
            If Tabla.Rows.Count > 0 Then
                For i = 0 To Tabla.Rows.Count - 1
                    ...
                    NombreCampo = ",CASE WHEN[" + IDProducto + "]=1 then '1' else '' end as '" & NombreProducto & "'"
            ...
            CargaGrilla(ConexionHerradura.localSqlServer, _
                        "SELECT DISTINCT REG.nombre_region as 'Región',CAD.nombre_cadena as 'Cadena',id_usuario as 'Promotor', nombre as 'Tienda', no_tienda as 'No. Tienda' " & _
                        " " + NombreCampos + " " & _
                        "FROM(SELECT DISTINCT TI.id_region, H.id_usuario, TI.id_cadena, TI.nombre, TI.no_tienda, " & _
                        "H.id_producto,H.agotado " & _
                        ...
                        " " + RegionSQL + " " & _
                        " " + PromotorSQL + " " & _
                        " " + CadenaSQL + ") AS Datos PIVOT(SUM(agotado) " & _
                        "FOR id_producto IN (" + Campos + ")) AS H " & _
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Reporte Agotamientos por Tiendas " + cmbPeriodo1.SelectedItem.ToString + ".xls")
