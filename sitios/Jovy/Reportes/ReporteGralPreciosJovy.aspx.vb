...
Partial Public Class ReporteGralPreciosJovy
    ...
    Sub CargarReporte()
        ...
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionJovy.localSqlServer, _
                        ...
                        "PROD.nombre_marca, PROD.nombre_categoria, PROD.piezas, PROD.nombre_producto, HDET.precio " & _
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Reporte Precios Generales " + cmbPeriodo.SelectedItem.ToString + ".xls")
