<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteExhibicionesJovy.aspx.vb" 
    Inherits="procomlcd.ReporteExhibicionesJovy" 
    Title="Jovy- Reporte" %>
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                            Width="100%" ShowFooter="True" CssClass="grid-view">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Propias" DataField="exhibidores"/> 
                                    <asp:BoundField HeaderText="Competencia" DataField="exhibidores_competencia"/> 
                                </Columns>   
