<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteGralPreciosJovy.aspx.vb" 
    Inherits="procomlcd.ReporteGralPreciosJovy" 
    Title="Jovy- Reporte" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderJovy" runat="Server">
    ...
    <!--titulo-pagina-->
        <div id="titulo-pagina">
                        Reporte precios por producto</div>
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                            Width="100%" ShowFooter="True" CssClass="grid-view">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Precios" DataField="precio" DataFormatString="{0:c2}" /> 
                                </Columns>   
