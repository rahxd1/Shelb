...
Partial Public Class ReporteAgotadosJovy
    ...
    Sub CargarReporte()
        ...
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionJovy.localSqlServer, _
                        ...
                        "HDET.inventarios, ISNULL(HDET.inventarios_bodega, '0') as inventarios_bodega, " & _
                        "ISNULL(HDET.inventarios,0)+ISNULL(HDET.inventarios_bodega, '0') as total " & _
                        ...
                        "AND ISNULL(HDET.inventarios,0)+ISNULL(HDET.inventarios_bodega, '0')<20 " & _
                        " " + RegionSQL + " " & _
                        " " + PromotorSQL + " " & _
                        " " + CadenaSQL + " " & _
                        " " + TiendaSQL + " " & _
    ...
    Sub Grafica()
        ...
        Dim SQLGrafica As String = "select PROD.nombre_categoria, PROD.nombre_producto, COUNT(ISNULL(HDET.inventarios,0)+ISNULL(HDET.inventarios_bodega, '0'))Cantidad " & _
                        "FROM Jovy_Historial as H  " & _
                        "INNER JOIN View_Jovy_Tiendas as TI ON TI.id_tienda=H.id_tienda " & _
                        "INNER JOIN Jovy_Productos_Historial_Det as HDET ON HDET.folio_historial = H.folio_historial  " & _
                        "INNER JOIN View_Jovy_Productos AS PROD ON PROD.id_producto = HDET.id_producto  " & _
                        ...
                        "GROUP BY PROD.nombre_marca, PROD.nombre_categoria, PROD.nombre_producto " & _
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Reporte agotados " + cmbPeriodo.SelectedItem.ToString + ".xls")
    ...
    Private Sub gridReporte_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gridReporte.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            Suma(2) = Suma(2) + e.Row.Cells(8).Text ''Suma inventario total
        End If
