<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteAgotadosJovy.aspx.vb" 
    Inherits="procomlcd.ReporteAgotadosJovy" 
    Title="Jovy- Reporte" %>
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                            Width="100%" ShowFooter="True" CssClass="grid-view">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Inventario Piso" DataField="inventarios" />
                                    <asp:BoundField HeaderText="Inventario Bodega" DataField="inventarios_bodega" />
                                    <asp:BoundField HeaderText="Inventario Total" DataField="Total" />                                         
                                </Columns>   
                                <FooterStyle CssClass="grid-footer" />                   
                            <EmptyDataTemplate>
                                <h1>Sin información</h1>
