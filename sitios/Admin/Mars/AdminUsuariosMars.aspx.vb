...
Partial Public Class AdminUsuariosMars
    ...
    Sub CargarUsuarios()
        ...
        CargaGrilla(ConexionMars.localSqlServer, "SELECT * FROM Usuarios as USU " & _
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Combo.LlenaDrop(ConexionMars.localSqlServer, TipoUsuarioSQL, "tipo_usuario", "id_tipo", cmbTipoUsuario)

            Combo.LlenaDrop(ConexionMars.localSqlServer, TipoUsuarioSQL, "tipo_usuario", "id_tipo", cmbFiltroTipoUsuario)
            Combo.LlenaDrop(ConexionMars.localSqlServer, UsuarioSQL, "id_usuario", "id_usuario", cmbFiltroUsuario)
            Combo.LlenaDrop(ConexionMars.localSqlServer, RegionSQL, "nombre_region", "id_region", cmbFiltroRegion)
            Combo.LlenaDrop(ConexionAdmin.localSqlServer, "SELECT DISTINCT id_proyecto, nombre_proyecto FROM Proyectos WHERE id_cliente=2", "nombre_proyecto", "id_proyecto", cmbProyecto)
