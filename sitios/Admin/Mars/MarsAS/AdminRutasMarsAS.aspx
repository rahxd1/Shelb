<%@ Page Language="vb" 
    ...
    CodeBehind="AdminRutasMarsAS.aspx.vb" 
    Inherits="procomlcd.AdminRutasMarsAS"
...
<!--titulo-pagina-->
    <div id="titulo-pagina">
        Rutas de promotores Mars Autoservicio</div>
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlRuta" runat="server"  ScrollBars="Both"
                        ...
                        <asp:GridView ID="gridRuta" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="clasificacion_tienda" HeaderText="Tipo tienda" />
                    ...
                    <asp:Panel ID="pnlAgregar" runat="server" Visible="False">
                        ...
                        <asp:CheckBox ID="chkFormatoPrecios" runat="server" Checked="false" 
                            Text="Formato precios" />
                        <br />
                        
                        <br />
                        
                        <asp:Label ID="lblFrecuencia" runat="server" Text="Frecuencia" CssClass="texto-lbl" />
                        <br />
