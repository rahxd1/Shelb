<%@ Page Language="vb" 
    ...
    CodeBehind="EliminarEventosMarsAS.aspx.vb" 
    Inherits="procomlcd.EliminarEventosMarsAS"
...
<!--titulo-pagina-->
    <div id="titulo-pagina">
        Eliminar eventos Mars Autoservicio</div>
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" CssClass="panel-grid" ScrollBars="Both">
                        <asp:GridView ID="gridRuta" runat="server" AutoGenerateColumns="False" DataKeyNames="id_tienda"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="estatus_precio" HeaderText="Estatus precio" />
                            </Columns>
