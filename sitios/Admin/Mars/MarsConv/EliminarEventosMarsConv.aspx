<%@ Page Language="vb" 
    ...
    CodeBehind="EliminarEventosMarsConv.aspx.vb" 
    Inherits="procomlcd.EliminarEventosMarsConv"
...
<!--titulo-pagina-->
    <div id="titulo-pagina">
        Eliminar eventos exhibiciones y precios Mars Conveniencia</div>
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" CssClass="panel-grid" ScrollBars="Both">
                        <asp:GridView ID="gridRuta" runat="server" AutoGenerateColumns="False"  DataKeyNames="id_tienda"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="estatus_precio" HeaderText="Estatus precios" />
                                <asp:BoundField DataField="estatus_exhibiciones" HeaderText="Estatus exhibiciones" />
                            </Columns>
