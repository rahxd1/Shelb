<%@ Page Language="vb" 
    ...
    CodeBehind="AdminTiendasMarsConv.aspx.vb" 
    Inherits="procomlcd.AdminTiendasMarsConv"
    Title="Administración Mars Conveniencia" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoAdministracion" runat="Server">
  
<!--titulo-pagina-->
    <div id="titulo-pagina">
        Tiendas Mars Conveniencia</div>
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>                
                    ...
                    <asp:Panel ID="pnlNuevo" runat="server" Visible="False" Width="100%">
                        ...
                        <asp:TextBox ID="txtNombreTienda" runat="server" MaxLength="50" 
                            CssClass="caja-texto-caja" />
                        ...
                        <asp:Label ID="lblCedis" runat="server" Text="Cedis" CssClass="caja-texto-lbl" />
                        <asp:DropDownList ID="cmbCedis" runat="server" CssClass="caja-texto-caja" />
                        <asp:RequiredFieldValidator ID="rfvCedis" runat="server" 
                            ControlToValidate="cmbCedis" ErrorMessage="Cedis" ValidationGroup="Tienda">*</asp:RequiredFieldValidator>
                        <br />
