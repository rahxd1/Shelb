<%@ Page Language="vb" 
    ...
    CodeBehind="CrearEventosMarsConv.aspx.vb" 
    Inherits="procomlcd.CrearEventosMarsConv"
...
<!--titulo-pagina-->
    <div id="titulo-pagina">
        Eventos rutas de promotores Mars Conveniencia</div>
        ...
        <div id="contenido-dos-columnas-1">
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="gridRutaExh" runat="server" AutoGenerateColumns="False" 
                        CssClass="grid-view" Height="16px" ShowFooter="True" style="text-align: left" 
