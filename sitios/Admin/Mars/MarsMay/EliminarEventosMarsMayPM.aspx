<%@ Page Language="vb" 
    ...
    CodeBehind="EliminarEventosMarsMayPM.aspx.vb" 
    Inherits="procomlcd.EliminarEventosMarsMayPM"
...
<!--titulo-pagina-->
    <div id="titulo-pagina">
        Eliminar eventos Mars Mayoreo - Verificadores</div>
        ...
        <div id="contenido-dos-columnas-1">
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:DropDownList ID="cmbSemana" runat="server" AutoPostBack="True" 
                        CssClass="caja-texto-caja" />
                    <br />
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" CssClass="panel-grid" ScrollBars="Both">
                        <asp:GridView ID="gridRuta" runat="server" AutoGenerateColumns="False" DataKeyNames="id_tienda" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="id_dia" HeaderText="Dia" />
