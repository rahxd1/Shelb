<%@ Page Language="vb" 
    ...
    CodeBehind="CrearEventosMarsMayPM.aspx.vb" 
    Inherits="procomlcd.CrearEventosMarsMayPM"
...
<!--titulo-pagina-->
    <div id="titulo-pagina">
        Eventos rutas de promotores Mars Mayoreo - Verificadores</div>
        ...
        <div id="contenido-dos-columnas-1">
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Label ID="lblSemana" runat="server" Text="Semana" CssClass="caja-texto-lbl" />
                    <asp:DropDownList ID="cmbSemana" runat="server" CssClass="caja-texto-caja" />
                    <asp:RequiredFieldValidator ID="rfvSemana" runat="server" CssClass="caja-texto-rf" 
                        ControlToValidate="cmbSemana" ErrorMessage="* Selecciona semana" 
                        ValidationGroup="Eventos" />
                    <br />
