...
Partial Public Class AdminCadenasFluid
    ...
    Public Function Guardar(ByVal IDCadena As String, ByVal Nombre As String, ByVal TipoCadena As String) As Integer
        Dim Tabla As DataTable = Tablas.Ver.DT(ConexionFluidmaster.localSqlServer, _
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Combo.LlenaDrop(ConexionFluidmaster.localSqlServer, "SELECT id_tipocadena, nombre_tipocadena FROM Cadenas_Tipo ORDER BY id_tipocadena", "nombre_tipocadena", "id_tipocadena", cmbTipoCadena)
        End If
    End Sub
