<%@Page Language="vb"
    ...
    Codebehind="AdminUsuariosFluid.aspx.vb" 
    Inherits="procomlcd.AdminUsuariosFluid"
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlNuevo" runat="server" Visible="False">
                        ...
                        <asp:Label ID="Label4" runat="server" Text="Tipo usuario" CssClass="caja-texto-lbl" />
