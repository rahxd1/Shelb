<%@Page Language="vb"
    ...
    Codebehind="AdminUsuariosHerradura.aspx.vb" 
    Inherits="procomlcd.AdminUsuariosHerradura"
                ...
                <ContentTemplate>                
                    ...
                    <asp:Panel ID="pnlConsulta" runat="server">
                        ...
                        <asp:Panel ID="pnlUsuarios" runat="server" ScrollBars="Both"
                            CssClass="panel-grid">
                            <asp:GridView ID="gridUsuario" runat="server" AutoGenerateColumns="False" Height="16px" 
