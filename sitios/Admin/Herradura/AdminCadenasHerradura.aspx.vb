...
Partial Public Class AdminCadenasHerradura
    ...
    Public Function Guardar(ByVal IDCadena As Integer, ByVal Nombre As String, _
                            ByVal TipoCadena As Integer) As Integer
        Dim Tabla As DataTable = Tablas.Ver.DT(ConexionHerradura.localSqlServer, _
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Combo.LlenaDrop(ConexionHerradura.localSqlServer, "SELECT id_tipocadena, nombre_tipocadena FROM Cadenas_Tipo ORDER BY id_tipocadena", "nombre_tipocadena", "id_tipocadena", cmbTipoCadena)
        End If
    End Sub
