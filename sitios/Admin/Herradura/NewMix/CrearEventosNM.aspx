<%@ Page Language="vb" 
    ...
    CodeBehind="CrearEventosNM.aspx.vb" 
    Inherits="procomlcd.CrearEventosNM"
...
<!--titulo-pagina-->
    <div id="titulo-pagina">
        Eventos rutas de promotores New Mix</div>
        ...
        <div id="contenido-dos-columnas-1">
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:GridView ID="gridRutaCadenas" runat="server" AutoGenerateColumns="False" 
