<%@ Page Language="vb" 
    ...
    CodeBehind="AdminCadenasJovy.aspx.vb" 
    Inherits="procomlcd.AdminCadenasJovy"
    Title="Administración Jovy"  %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoAdministracion" runat="Server">
     
<!--PAGE TITLE-->
<div id="titulo-pagina">Catalogo de cadenas Jovy</div>
                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlNuevo" runat="server" Visible="False" Width="100%">
                        ...
                        <asp:TextBox ID="txtNombreCadena" runat="server" CssClass="caja-texto-caja" 
                            MaxLength="50" />
                        <asp:RequiredFieldValidator ID="rfvNombreCadena" runat="server" CssClass="caja-texto-rf"  
                        ...
                        <asp:DropDownList ID="cmbTipoCadena" runat="server" AutoPostBack="True" CssClass="caja-texto-caja"  />
                        <asp:RequiredFieldValidator ID="rfvTipoCadena" runat="server" CssClass="caja-texto-rf" 
