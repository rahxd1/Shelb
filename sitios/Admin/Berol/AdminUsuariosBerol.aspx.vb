...
Partial Public Class AdminUsuariosBerol
    ...
    Sub CargarUsuarios()
        ...
        CargaGrilla(ConexionBerol.localSqlServer, _
                    ...
                    "WHERE id_usuario<>'' " & _
                    " " + FiltroRegion + FiltroTipoUsuario + FiltroUsuario + " " & _
                    "ORDER BY id_usuario", gridUsuario)
    End Sub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Combo.LlenaDrop(ConexionBerol.localSqlServer, TipoUsuarioSQL, "tipo_usuario", "id_tipo", cmbTipoUsuario)

            Combo.LlenaDrop(ConexionBerol.localSqlServer, TipoUsuarioSQL, "tipo_usuario", "id_tipo", cmbFiltroTipoUsuario)
            Combo.LlenaDrop(ConexionBerol.localSqlServer, UsuarioSQL, "id_usuario", "id_usuario", cmbFiltroUsuario)
            Combo.LlenaDrop(ConexionBerol.localSqlServer, RegionSQL, "nombre_region", "id_region", cmbFiltroRegion)
            Combo.LlenaDrop(ConexionAdmin.localSqlServer, "SELECT DISTINCT id_proyecto, nombre_proyecto FROM Proyectos WHERE id_cliente=17", "nombre_proyecto", "id_proyecto", cmbProyecto)
