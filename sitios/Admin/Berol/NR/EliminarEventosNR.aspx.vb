...
Partial Public Class EliminarEventosNR
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Combo.LlenaDrop(ConexionBerol.localSqlServer, "SELECT * FROM NR_Periodos ORDER BY id_periodo DESC", "nombre_periodo", "id_periodo", cmbPeriodo)
        End If
    End Sub
        ...
        If Not cmbPromotor.SelectedValue = "" Then
            If Not cmbPeriodo.SelectedValue = "" Then
                ...
                CargaGrilla(ConexionBerol.localSqlServer, _
                            ...
                            "CASE RE.estatus_frentes when 1 then 'CAPTURADO' when 4 then '' when 0 then 'sin captura' end as estatus_frentes, " & _
                            "CASE RE.estatus_inventarios when 1 then 'CAPTURADO' when 4 then '' when 0 then 'sin captura' end as estatus_inventarios, " & _
                            "CASE RE.estatus_comentarios when 1 then 'CAPTURADO' when 4 then '' when 0 then 'sin captura' end as estatus_comentarios " & _
                            "FROM NR_Rutas_Eventos AS RE " & _
    ...
    Private Sub gridRuta_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gridRuta.RowDeleting
        BD.Execute(ConexionBerol.localSqlServer, _
                   "DELETE FROM NR_Rutas_Eventos " & _
    ...
    Protected Sub cmbPeriodo_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles cmbPeriodo.SelectedIndexChanged
        If Not cmbPeriodo.SelectedValue = "" Then
            Combo.LlenaDrop(ConexionBerol.localSqlServer, "SELECT DISTINCT id_usuario FROM NR_Rutas_Eventos WHERE id_periodo=" & cmbPeriodo.SelectedValue & " ORDER BY id_usuario", "id_usuario", "id_usuario", cmbPromotor)
