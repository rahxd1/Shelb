<%@ Page Language="vb" 
    ...
    CodeBehind="EliminarEventosNR.aspx.vb" 
    Inherits="procomlcd.EliminarEventosNR"
...
<!--titulo-pagina-->
    <div id="titulo-pagina">
        Eliminar eventos promotor Newell Rubbermaid</div>
                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" CssClass="panel-grid" ScrollBars="Both">
                        <asp:GridView ID="gridRuta" runat="server" AutoGenerateColumns="False" 
                            CssClass="grid-view" DataKeyNames="id_tienda" ShowFooter="True" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="estatus_frentes" HeaderText="Frentes y exhibiciones" />
                                <asp:BoundField DataField="estatus_inventarios" HeaderText="Inventarios" />
                                <asp:BoundField DataField="estatus_comentarios" HeaderText="Comentarios" />
                            </Columns>
