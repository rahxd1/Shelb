<%@ Page Language="vb" 
    ...
    CodeBehind="EliminarEventosSupNR.aspx.vb" 
    Inherits="procomlcd.EliminarEventosSupNR"
...
<!--titulo-pagina-->
    <div id="titulo-pagina">
        Eliminar eventos supervisor Newell Rubbermaid</div>
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" CssClass="panel-grid" ScrollBars="Both">
                        <asp:GridView ID="gridRuta" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="estatus_precios" HeaderText="Precios" />
                                <asp:BoundField DataField="estatus_fotos" HeaderText="Fotografias" />
                            </Columns>
