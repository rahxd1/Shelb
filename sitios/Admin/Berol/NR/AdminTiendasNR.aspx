            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlConsulta" runat="server" Visible="False">
                        ...
                        <asp:Label ID="lblFiltroFormato" runat="server" Text="Formato" CssClass="caja-texto-lbl" />        
                        <asp:DropDownList ID="cmbFiltroFormato" runat="server" AutoPostBack="True" 
                            CssClass="caja-texto-caja" />
                        <br />
                        ...
                        <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                            ...
                            <asp:GridView ID="gridTiendas" runat="server" AutoGenerateColumns="False" 
                                ...
                                <Columns>       
                                    ...
                                    <asp:BoundField HeaderText="Determinante" DataField="codigo"/>
                    ...
                    <asp:Panel ID="pnlNuevo" runat="server" Visible="False" Width="100%">
                        <asp:Label ID="IDTienda" runat="server" Font-Bold="True" Visible="false" />
                        <br />
                        
                        <asp:Label ID="lblDeterminante" runat="server" Text="Determinante" CssClass="caja-texto-lbl" />        
                        ...
                        <asp:RequiredFieldValidator ID="rfvFormato" runat="server"  CssClass="caja-texto-rf"
                            ControlToValidate="cmbFormato" ErrorMessage="Formato" ValidationGroup="Tienda">*</asp:RequiredFieldValidator>
                        <br />
