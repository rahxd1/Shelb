<%@ Page Language="vb" 
    ...
    CodeBehind="AdminPeriodosNR.aspx.vb" 
    Inherits="procomlcd.AdminPeriodosNR"
...
<!--titulo-pagina -->
    <div id="titulo-pagina">Periodos promotor Newell Rubbermaid</div>    
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlNuevo" runat="server" Visible="False">
                        <asp:Label ID="lblIDPeriodo" runat="server" Font-Bold="True" Visible="false" />
                        <br />
                        
                        <asp:Label ID="lblNombrePeriodo" runat="server" Text="Nombre periodo" CssClass="caja-texto-lbl" />
                        <asp:TextBox ID="txtNombrePeriodo" runat="server" 
                            MaxLength="50" CssClass="caja-texto-caja" Width="350px" />
                        <asp:RequiredFieldValidator ID="rfvNombrePeriodo" runat="server" 
                            ControlToValidate="txtNombrePeriodo" ErrorMessage="Nombre periodo" 
                            ValidationGroup="Periodo" CssClass="caja-texto-rf">*</asp:RequiredFieldValidator>
                        <br />
                        ...
                        <img alt="" border="0" src="../../../../Img/SmallCalendar.gif" /></a><asp:RequiredFieldValidator 
                            ...
                            ErrorMessage="Fecha inicio" ValidationGroup="Periodo" CssClass="caja-texto-rf">*</asp:RequiredFieldValidator>
                        <br />
                        ...
                        <img border="0" src="../../../../Img/SmallCalendar.gif" /></a><asp:RequiredFieldValidator 
                            ID="rfvFechaFin" runat="server" ControlToValidate="txtFechaFin" 
                            ErrorMessage="Fecha fin" ValidationGroup="Periodo" CssClass="caja-texto-rf">*</asp:RequiredFieldValidator>
                        <br />
                        ...
                        <img border="0" src="../../../../Img/SmallCalendar.gif" /></a><asp:RequiredFieldValidator 
                            ...
                            ErrorMessage="Fecha cierre" ValidationGroup="Periodo" CssClass="caja-texto-rf">*</asp:RequiredFieldValidator>
                        <br />
