...
Partial Public Class AdminPeriodosSupNR
    ...
    Sub CargarPeriodo()
        ...
        CargaGrilla(ConexionBerol.localSqlServer, _
                    "SELECT * FROM NR_Periodos_Sup ORDER BY id_periodo DESC",gridPeriodo)
    End Sub
