<%@ Page Language="vb" 
    ...
    CodeBehind="AdminRutasNR.aspx.vb" 
    Inherits="procomlcd.AdminRutasNR"
    Title="Administración Newell Rubbermaid" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoAdministracion" runat="Server">
  
<!--titulo-pagina-->
    <div id="titulo-pagina">Rutas de promotores Newell Rubbermaid</div>
        ...
        <div id="contenido-dos-columnas-1">
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlRuta" runat="server" ScrollBars="Both" CssClass="panel-grid">
                        <asp:GridView ID="gridRuta" runat="server" AutoGenerateColumns="False" 
                            Width="100%" DataKeyNames="id_tienda" CssClass="grid-view" ShowFooter="True" 
                            GridLines="None">
                            <Columns>
                    ...
                    <asp:Panel ID="pnlAgregar" runat="server" Visible="False">
                        ...
                        <asp:ListBox ID="ListEstado" runat="server" AutoPostBack="True"
                            CssClass="caja-texto-caja" />
                        <br />
                        
                        <asp:Label ID="lblCadena" runat="server" Text="Cadena" CssClass="caja-texto-lbl" />
                        <asp:ListBox ID="ListCadena" runat="server" AutoPostBack="True"
                            CssClass="caja-texto-caja" />
                        <br />
                        
                        <asp:Label ID="lblTienda" runat="server" Text="Tienda" CssClass="caja-texto-lbl" />
                        <asp:ListBox ID="ListTienda" runat="server" 
                            CssClass="caja-texto-caja" />
