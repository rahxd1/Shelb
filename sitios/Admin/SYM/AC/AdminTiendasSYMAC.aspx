<%@ Page Language="vb" 
    ...
    CodeBehind="AdminTiendasSYMAC.aspx.vb" 
    Inherits="procomlcd.AdminTiendasSYMAC"
...
<!--titulo-pagina-->
    <div id="titulo-pagina">
        Tiendas SYM Anaquel y Catalogación</div>
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlNuevo" runat="server" Visible="False" Width="100%">
                        ...
                        <asp:TextBox ID="txtNoTienda" runat="server" MaxLength="20" 
                            CssClass="caja-texto-caja" />
                        <br />
