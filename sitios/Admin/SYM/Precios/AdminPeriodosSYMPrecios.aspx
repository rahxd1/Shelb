<%@ Page Language="vb" 
    ...
    CodeBehind="AdminPeriodosSYMPrecios.aspx.vb" 
    Inherits="procomlcd.AdminPeriodosSYMPrecios"
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlNuevo" runat="server" Visible="False">
                        ...
                        <asp:TextBox ID="txtNombrePeriodo" runat="server" MaxLength="50" Width="350px"
                        ...
                        <asp:Label ID="lblTipoPeriodo" runat="server" Text="Tipo periodo" CssClass="caja-texto-lbl" />
                        <asp:DropDownList ID="cmbTipoPeriodo" runat="server" CssClass="caja-texto-caja" />
                        <asp:RequiredFieldValidator ID="TipoPeriodo" runat="server" 
                            ControlToValidate="cmbTipoPeriodo" ErrorMessage="Tipo periodo" ValidationGroup="Periodo">*</asp:RequiredFieldValidator>
                        <br />
                        ...
                        <asp:RequiredFieldValidator ID="FechaInicio" runat="server" ControlToValidate="txtFechaInicio" 
                        ...
                        <img alt="" border="0" src="../../../../Img/SmallCalendar.gif" /></a>
                        <asp:RequiredFieldValidator ID="rfvtxtFechaCierre" runat="server" ControlToValidate="txtFechaCierre" 
