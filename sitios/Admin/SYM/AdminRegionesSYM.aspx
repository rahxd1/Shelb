<%@ Page Language="vb"
    ...
    CodeBehind="AdminRegionesSYM.aspx.vb" 
    Inherits="procomlcd.AdminRegionesSYM"
    Title="Administración Sanchez y Martin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoAdministracion" runat="Server">
  
<!--titulo-pagina-->
    <div id="titulo-pagina">Regiones Sanchez y Martin</div>
                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlNuevo" runat="server" Visible="False">
                        ...
                        <asp:RequiredFieldValidator ID="rfvNombreRegion" runat="server" 
                            ControlToValidate="txtNombreRegion" ErrorMessage="Nombre región" 
                            ValidationGroup="Region">*</asp:RequiredFieldValidator>
                        <br />
