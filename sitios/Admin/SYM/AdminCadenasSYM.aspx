<%@ Page Language="vb" 
    ...
    CodeBehind="AdminCadenasSYM.aspx.vb" 
    Inherits="procomlcd.AdminCadenasSYM"
    Title="Administración Sanchez y Martin"  %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContenidoAdministracion" runat="Server">
     
<!--PAGE TITLE-->
<div id="titulo-pagina">Cadenas Sanchez y Martin</div>
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlNuevo" runat="server" Visible="False" Width="100%">
                        ...
                        <asp:Label ID="lblGrupoCadena" runat="server" Text="Grupo cadena" CssClass="caja-texto-lbl" />
                        <asp:DropDownList ID="cmbGrupoCadena" runat="server" AutoPostBack="True" 
                            CssClass="caja-texto-caja" />
                        <asp:RequiredFieldValidator ID="rfvGrupoCadena" runat="server" 
                            ControlToValidate="cmbGrupoCadena" ErrorMessage="Grupo cadena" ValidationGroup="Cadena">*</asp:RequiredFieldValidator>
                        <br />
 ...
 <!--CONTENT SIDE COLUMN AVISOS -->
        <div id="contenido-dos-columnas-2">
            ...
            <ul class="list-of-links">
                <li><a href="/sitios/Admin/SYM/AdminUsuariosSYM.aspx">Usuarios</a></li>
                <li><a href="/sitios/Admin/SYM/AdminCadenasSYM.aspx">Cadenas</a></li>
                <li><a href="/sitios/Admin/SYM/AdminRegionesSYM.aspx">Regiones</a></li>
            </ul>
