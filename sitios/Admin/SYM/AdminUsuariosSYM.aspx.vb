...
Partial Public Class AdminUsuariosSYM
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Combo.LlenaDrop(ConexionSYM.localSqlServer, TipoUsuarioSQL, "tipo_usuario", "id_tipo", cmbTipoUsuario)


            Combo.LlenaDrop(ConexionSYM.localSqlServer, TipoUsuarioSQL, "tipo_usuario", "id_tipo", cmbFiltroTipoUsuario)
            Combo.LlenaDrop(ConexionSYM.localSqlServer, UsuarioSQL, "id_usuario", "id_usuario", cmbFiltroUsuario)
            Combo.LlenaDrop(ConexionSYM.localSqlServer, RegionSQL, "nombre_region", "id_region", cmbFiltroRegion)
            Combo.LlenaDrop(ConexionAdmin.localSqlServer, "SELECT DISTINCT id_proyecto, nombre_proyecto FROM Proyectos WHERE id_cliente=8", "nombre_proyecto", "id_proyecto", cmbProyecto)
