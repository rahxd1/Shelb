...
Partial Public Class ReporteComentariosSYMDemos
    ...
    Sub CargarReporte()
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionSYM.localSqlServer, _
                        "select REG.nombre_region,US.plaza,H.id_usuario,CAD.nombre_cadena,H.nombre_tienda,H.comentarios " & _
                        "FROM Demos_Historial as H " & _
                        ...
                        "WHERE H.id_periodo=" & cmbPeriodo.SelectedValue & " AND H.comentarios<>'' " & _
