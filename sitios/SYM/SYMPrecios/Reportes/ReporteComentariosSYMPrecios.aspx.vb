...
Partial Public Class ReporteComentariosSYMPrecios
    ...
    Sub CargarReporte()
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionSYM.localSqlServer, _
                        "select REG.nombre_region, US.plaza, H.id_usuario, CAD.nombre_cadena, H.comentario_general " & _
                        "FROM Precios_Historial as H " & _
                        ...
                        "ORDER BY REG.nombre_region, US.plaza, H.id_usuario, CAD.nombre_cadena", _
                        gridReporte)
        Else
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Reporte comentarios captura " + cmbPeriodo.SelectedItem.ToString + ".xls")
