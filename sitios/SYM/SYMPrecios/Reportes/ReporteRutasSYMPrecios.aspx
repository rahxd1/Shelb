<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteRutasSYMPrecios.aspx.vb" 
    Inherits="procomlcd.ReporteRutasSYMPrecios" 
        ...
        <div id="content-main-two-column">
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Label ID="lblTipoCaptura" runat="server" Text="Tipo captura" CssClass="lbl" />
                    <asp:DropDownList ID="cmbTipoCaptura" runat="server" CssClass="cmb" 
                        AutoPostBack="True" /><br />    
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                            Width="100%" ShowFooter="True" CssClass="grid-view">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Tipo captura" DataField="Tipo"/>
                                </Columns>   
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="cmbTipoCaptura" EventName="SelectedIndexChanged" />
                </Triggers>
            </asp:UpdatePanel>        
        </div>
