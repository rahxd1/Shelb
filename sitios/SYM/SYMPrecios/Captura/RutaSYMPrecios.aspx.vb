...
Partial Public Class RutaSYMPrecios
    ...
    Private Sub PeriodoActual()
        Dim Tabla As DataTable = Tablas.Ver.DT(ConexionSYM.localSqlServer, _
                                               "SELECT * FROM Precios_Periodos ORDER BY id_periodo DESC")
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            Else
                ...
                Combo.LlenaDrop(ConexionSYM.localSqlServer, "SELECT TOP 4 * FROM Precios_Periodos order by id_periodo DESC", "nombre_periodo", "id_periodo", cmbPeriodo)
            End If
    ...
    Sub CargarRuta()
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            If Tipo_usuario = 10 Then
                SQLCargaRuta = "execute Precios_Cargar_Ruta " & cmbPeriodo.SelectedValue & ",'" & HttpContext.Current.User.Identity.Name & "'"
            Else
                SQLCargaRuta = "execute Precios_Cargar_Ruta_2 " & cmbPeriodo.SelectedValue & ",'" & cmbPromotor.SelectedValue & "'"
            End If
    ...
    Private Sub gridRUTAS_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gridRutas.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            If PeriodoActivoSiNo = 1 Then
                ...
                If Tipo_usuario = 10 Then
                    e.Row.Cells(2).Text = "Tienda Cerrada"
                End If
            End If
        End If
    End Sub
    ...
    Private Sub PeriodoActivo()
        Dim Tabla As DataTable = Tablas.Ver.DT(ConexionSYM.localSqlServer, _
                                               "SELECT * FROM Precios_Periodos where id_periodo =" & cmbPeriodo.Text & "")
