<%@ Page Language="vb" 
    ...
    CodeBehind="menu_SYMPrecios.aspx.vb" 
    Inherits="procomlcd.menu_SYMPrecios"
            ...
            <div id="three-column-container">
                <div id="three-column-side1">
                    <table style="width: 100%">
                        <tr>
                            <td align="center">
                                <a href="Captura/RutaSYMPrecios.aspx">
                                <img src="../../../Img/Menu_Captura.jpg" class="photo-border" alt="Enter Alt Text Here" /></a></td>
                        </tr>
                    </table>
                <h2><a href="Captura/RutaSYMPrecios.aspx">Captura</a></h2>
                    <p>
                    ...
                    <table style="width: 100%">
                        <tr>
                            <td align="center" style="text-align: center">
                                <a href="Reportes/ReportesSYMPrecios.aspx">
                                <img src="../../../Img/Menu_Reportes.jpg" class="photo-border" alt="Enter Alt Text Here" /></a></td>
                        </tr>
                    </table>
            <h2><a href="Reportes/ReportesSYMPrecios.aspx">Reportes</a></h2>
                    <p>
