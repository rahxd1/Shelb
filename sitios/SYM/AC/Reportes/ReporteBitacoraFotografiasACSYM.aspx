<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteBitacoraFotografiasACSYM.aspx.vb" 
    Inherits="procomlcd.ReporteBitacoraFotografiasACSYM" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSYMAC" runat="Server">
    ...
    <!--titulo-pagina-->
        <div id="titulo-pagina">
                        Reporte bitácora fotografías</div>
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                            Width="100%" ShowFooter="True" CssClass="grid-view">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Cantidad de tiendas con fotografías" DataField="tiendas"/>  
                                </Columns>   
