...
Partial Public Class ReporteFrentesACSYM
    ...
    Sub VerProductos()
        Dim Tabla As DataTable = Tablas.Ver.DT(ConexionSYM.localSqlServer, _
                                               "select PROD.id_producto, PROD.nombre_producto + ' ('+ TPROD.nombre_tipoproducto + ')' as Producto " & _
                                    "FROM Linea_Productos_Nuevo as PROD " & _
                                    "INNER JOIN Anaquel_Tipo_Productos as TPROD ON TPROD.id_tipo = PROD.id_tipo WHERE id_empresa=1")
        If Tabla.Rows.Count > 0 Then
            For i = 0 To Tabla.Rows.Count - 1
                ...
                CampoTitulo(i) = ",ISNULL([" & Tabla.Rows(i)("id_producto") & "],0) as '" & Tabla.Rows(i)("producto") & "'"
    ...
    Sub CargarReporte()
        Dim RegionSQL, CadenaSQL, EstadoSQL, EjecutivoSQL, SupervisorSQL, CiudadSQL, PromotorSQL, TiendaSQL As String
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionSYM.localSqlServer, _
                        ...
                        "id_ejecutivo as 'Ejecutivo', id_supervisor as 'Supervisor',Ciudad,id_usuario as 'Promotor',nombre as 'Tienda'" & _
                        " " + CamposTitulos + " " & _
                        "FROM(select DISTINCT TI.nombre_region,TI.nombre_cadena,TI.nombre_estado, RE.id_ejecutivo, RE.id_supervisor, " & _
                        " TI.ciudad, H.id_usuario, TI.nombre, HDET.id_producto, HDET.frentes " & _
