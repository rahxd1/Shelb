<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteComentariosACSYM.aspx.vb" 
    Inherits="procomlcd.ReporteComentariosACSYM" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSYMAC" runat="Server">
    ...
    <!--titulo-pagina-->
        <div id="titulo-pagina">
                        Reporte comentarios de Anaquel y Catalogación</div>
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                            Width="100%" ShowFooter="True" CssClass="grid-view">
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Comentarios Anaquel" DataField="comentario_general"/>  
                                    <asp:BoundField HeaderText="Comentarios Catalogación" DataField="comentarios2"/>  
                                </Columns>   
