<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteGaleriaExhibicionesACSYM.aspx.vb" 
    Inherits="procomlcd.ReporteGaleriaExhibicionesACSYM"
    Title="SYM Anaquel y Catalogación - Galería" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentSYMAC" runat="Server">

<!--titulo-pagina-->
        <div id="titulo-pagina">
            Mejores exhibiciones por división</div>
