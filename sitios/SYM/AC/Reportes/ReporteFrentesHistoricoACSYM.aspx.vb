...
Partial Public Class ReporteFrentesHistoricoACSYM
        ...
        If cmbPeriodo1.SelectedValue <> "" And cmbPeriodo2.SelectedValue <> "" Then
            If cmbPeriodo1.SelectedValue >= cmbPeriodo2.SelectedValue Then
                Dim Tabla As DataTable = Tablas.Ver.DT(ConexionSYM.localSqlServer, _
                                                       "SELECT distinct TPROD.tipo_grupo,TPROD.nombre_grupos " & _
                                         "FROM Grupos as TPROD " & _
                ...
                If Tabla.Rows.Count > 0 Then
                    For i = 0 To Tabla.Rows.Count - 1
                        CampoTituloC(i) = ",ISNULL([" & Tabla.Rows(i)("tipo_grupo") & "],0)as [" & Tabla.Rows(i)("tipo_grupo") & "]"
                        CamposTitulosC = CamposTitulosC + CampoTituloC(i)

                        If i = 0 Then
                            CampoC(i) = "[" & Tabla.Rows(i)("tipo_grupo") & "]" : Else
                            CampoC(i) = ",[" & Tabla.Rows(i)("tipo_grupo") & "]" : End If
                ...
                Dim Tabla2 As DataTable = Tablas.Ver.DT(ConexionSYM.localSqlServer, _
                                                       ...
                                                       "WHERE id_periodo >=" & cmbPeriodo1.SelectedValue & " AND id_periodo<=" & cmbPeriodo2.SelectedValue & "")
                ...
                Dim SQLGrafica As String = "SELECT DISTINCT id_periodo,nombre_periodo " & _
                                        " " + CamposTitulosC + " " & _
                                        "FROM(SELECT id_periodo,nombre_periodo,id_empresa,sum(frentes)frentes " & _
                                        ...
                                        " " + PromotorSQL + " " & _
                                        " " + TiendaSQL + " " & _
                                        "GROUP BY id_periodo,nombre_periodo,id_tipo) AS Datos PIVOT(SUM(frentes) " & _
                                        "FOR id_empresa IN (" + CamposC + ")) AS PivotTable " & _
                                        "ORDER BY id_periodo "
                ...
                Dim SQLGrilla As String = "SELECT DISTINCT nombre_region as 'División',nombre_cadena as 'Cadena',nombre_estado as 'Estado'," & _
                                        ...
                                        "id_supervisor,id_usuario,ciudad,nombre,SUM(frentes)frentes " & _
                                        "FROM View_SYM_Anaquel_Historial " & _
                                        "WHERE H.id_periodo >=" & cmbPeriodo1.SelectedValue & " AND H.id_periodo<=" & cmbPeriodo2.SelectedValue & " " & _
                                        " " + RegionSQL + " " & _
                                        " " + CadenaSQL + " " & _
                                        ...
                                        "id_supervisor,id_usuario,ciudad,nombre) AS Datos PIVOT(SUM(frentes)  " & _
                ...
                Dim Linea1, Linea2, Linea3, Linea4, Linea5 As New StringBuilder()
                ...
                For i = 0 To TablaGraf.Rows.Count - 1
                    ...
                    Linea5.Append("<set value='" & TablaGraf.Rows(i)("6") & "' />")
                Next
                ...
                strXML.Append(strCategories.ToString() & Linea1.ToString() & Linea2.ToString() & Linea3.ToString() & Linea4.ToString() & Linea5.ToString())
                strXML.Append("</chart>")

                Dim outPut As String = ""
                outPut = FusionCharts.RenderChartHTML("../../../../FusionCharts/MSLine.swf", "", strXML.ToString(), "chart1", "650", "350", False, False)
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Reporte Historico Anaquel " + cmbPeriodo1.SelectedItem.ToString + " al " + cmbPeriodo2.SelectedItem.ToString + ".xls")
