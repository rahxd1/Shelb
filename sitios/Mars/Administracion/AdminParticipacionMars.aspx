<%@ Page Language="vb" Culture="es-MX" 
    ...
    CodeBehind="AdminParticipacionMars.aspx.vb" 
    Inherits="procomlcd.AdminParticipacionMars"
            ...
            <asp:Panel ID="PnlGrid" runat="server" Visible="False" Width="487px">
                <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                    ...
                    <RowStyle BackColor="#FFFBD6" ForeColor="#333333" />
                        <Columns>
                            <asp:BoundField HeaderText="Usuario" DataField="id_promotor"/> 
                            <asp:BoundField HeaderText="en Comunidad" DataField="ParticipacionBlog"/> 
                            <asp:BoundField HeaderText="en Comentarios" DataField="ParticipacionComentarios"/> 
                            <asp:BoundField HeaderText="en Fotos Eventos" DataField="ParticipacionFotosEventos"/> 
                        </Columns>
