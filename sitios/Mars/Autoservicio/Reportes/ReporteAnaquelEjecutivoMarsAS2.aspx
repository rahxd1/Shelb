<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteAnaquelEjecutivoMarsAS2.aspx.vb" 
    Inherits="procomlcd.ReporteAnaquelEjecutivoMarsAS2"
                ...
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" Width="100%" 
                            ShowFooter="True" CssClass="grid-view" GridLines="None" >
                            <Columns>
                                <asp:TemplateField HeaderText="Ejecutivo">
                                    <ItemTemplate>
                                        <a href="ReporteDetalleAnaquelEjecutivoMarsAS2.aspx?orden=<%#Eval("orden")%>&region_mars=<%#Eval("region_mars")%>"><%#Eval("Ejecutivo")%></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
