...
Partial Public Class ReporteComentariosPreciosMarsAS2
    ...
    Sub SQLCombo()
        MarsAS.SQLsCombo(cmbPeriodo.SelectedValue, cmbQuincena.SelectedValue, _
                         ...
                         cmbCadena.SelectedValue, "View_Historial_AS_Precios")
    End Sub
    ...
    Sub CargarReporte()
        ...
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionMars.localSqlServer, _
                        "SELECT H.id_quincena,H.id_usuario,H.nombre_region, H.nombre_cadena, " & _
                        "H.nombre_formato,H.nombre_grupo,H.nombre, H.comentarios,H.Ejecutivo " & _
                        "FROM View_Historial_AS_Precios as H " & _
                        "WHERE H.comentarios<>'' AND H.orden=" & cmbPeriodo.SelectedValue & " " & _
