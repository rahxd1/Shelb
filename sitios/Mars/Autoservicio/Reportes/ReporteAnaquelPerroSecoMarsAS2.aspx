<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteAnaquelPerroSecoMarsAS2.aspx.vb" 
    Inherits="procomlcd.ReporteAnaquelPerroSecoMarsAS2"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
                        Reporte anaquel perro adulto seco</div>
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" Width="645px" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Mars razas pequeñas" DataField="15"/>  
                                <asp:BoundField HeaderText="Mars resto seco" DataField="1"/>  
                                <asp:BoundField HeaderText="Competencia razas pequeñas" DataField="16"/> 
                                <asp:BoundField HeaderText="Competencia resto seco" DataField="5"/> 
                                <asp:BoundField HeaderText="Total anaquel perro seco" DataField="Total"/> 
                                <asp:BoundField HeaderText="% Mars razas pequeñas" DataField="Por15"/> 
                                <asp:BoundField HeaderText="% Mars resto seco" DataField="Por1"/> 
                                <asp:BoundField HeaderText="% Competencia" DataField="Por5"/> 
                                <asp:BoundField HeaderText="% Total Mars" DataField="PorMars"/>
