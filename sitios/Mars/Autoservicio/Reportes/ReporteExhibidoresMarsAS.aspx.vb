...
Partial Public Class ReporteExhibidoresMarsAS
    ...
    Sub CargarReporte()
        ...
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionMars.localSqlServer, _
                        "SELECT H.id_quincena,H.id_usuario,REG.nombre_region, CAD.nombre_cadena,GRUP.nombre_grupo, Ti.nombre, " & _
                        "REL.region_mars +' - '+US.nombre Ejecutivo, FORM.nombre_formato, " & _
                        "CASE WHEN H.PDQ =1 then 'Si' else 'No' end as PDQ, " & _
                        "CASE WHEN H.Floor_display=1 then 'Si' else 'No' end as Floor " & _
                        ...
                        "INNER JOIN Cadena_Formato as FORM ON FORM.id_formato=TI.id_tienda " & _
                        "INNER JOIN Cadenas_Tiendas as CAD ON CAD.id_cadena= TI.id_cadena " & _
                        "INNER JOIN Cadena_Grupo as GRUP ON TI.id_grupo = GRUP.id_grupo " & _
                        ...
                        "WHERE H.id_quincena<>'' AND H.orden=" & cmbPeriodo.SelectedValue & " " & _
                        " " + QuincenaSQL + RegionSQL + " " & _
                        " " + EjecutivoSQL + SupervisorSQL + PromotorSQL + " " & _
                        " " + CadenaSQL + TiendaSQL + TiendaSQL + " " & _
                        "ORDER BY H.id_quincena, REG.nombre_region, CAD.nombre_cadena, Ti.nombre ", _
                        Me.gridReporte)
        Else
