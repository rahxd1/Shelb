<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteAnaquelPerroSecoMarsAS.aspx.vb" 
    Inherits="procomlcd.ReporteAnaquelPerroSecoMarsAS"
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" Width="645px" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Competencia adulto seco" DataField="5"/> 
