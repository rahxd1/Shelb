<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteExhibicionesPromotorMarsAS.aspx.vb" 
    Inherits="procomlcd.ReporteExhibicionesPromotorMarsAS"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
                        Reporte exhibiciones por promotor</div>
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" Width="100%" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Promotor">
                                    <ItemTemplate>
                                        <a href="ReporteDetalleExhibicionesPromotorMarsAS.aspx?id_periodo=<%#Eval("id_periodo")%>&id_usuario=<%#Eval("id_usuario")%>"><%#Eval("id_usuario")%></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
