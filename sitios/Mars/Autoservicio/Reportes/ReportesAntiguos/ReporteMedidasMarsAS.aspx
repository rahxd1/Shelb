<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteMedidasMarsAS.aspx.vb" 
    Inherits="procomlcd.ReporteMedidasMarsAS"
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" Width="645px" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Longitud (L)" DataField="1"/>
                                    <asp:BoundField HeaderText="Altura (A)" DataField="2"/>
                                    <asp:BoundField HeaderText="Profundidad (P)" DataField="3"/>
                                </Columns>
