<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteAnaquelPromotorMarsAS2.aspx.vb" 
    Inherits="procomlcd.ReporteAnaquelPromotorMarsAS2"
                            ...
                            ShowFooter="True" CssClass="grid-view">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Promotor">
                                        <ItemTemplate>
                                            <a href="ReporteDetalleAnaquelPromotorMarsAS2.aspx?orden=<%#Eval("orden")%>&id_usuario=<%#Eval("id_usuario")%>"><%#Eval("id_usuario")%></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
