<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteExhibidoresMarsAS.aspx.vb" 
    Inherits="procomlcd.ReporteExhibidoresMarsAS"
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" Width="645px" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="PDQ" DataField="PDQ"/>
                                    <asp:BoundField HeaderText="Floor display" DataField="Floor"/>  
                                </Columns>
