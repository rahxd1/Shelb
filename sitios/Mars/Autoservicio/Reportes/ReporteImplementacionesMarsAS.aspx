<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteImplementacionesMarsAS.aspx.vb" 
    Inherits="procomlcd.ReporteImplementacionesMarsAS"
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" Width="645px" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Implementacion" DataField="nombre_proceso"/>
                                    <asp:BoundField HeaderText="Fecha implementacion" DataField="fecha_implementacion"/>  
                                    <asp:BoundField HeaderText="Cenefas" DataField="1"/> 
                                    <asp:BoundField HeaderText="Cenefas copete" DataField="2"/> 
                                    <asp:BoundField HeaderText="Stopper" DataField="3"/> 
                                    <asp:BoundField HeaderText="Maxi stopper" DataField="4"/> 
                                    <asp:BoundField HeaderText="Mini stopper" DataField="5"/> 
                                    <asp:BoundField HeaderText="Dangler" DataField="6"/> 
                                    <asp:BoundField HeaderText="Teatritos" DataField="7"/> 
                                    <asp:BoundField HeaderText="Charolas" DataField="8"/> 
                                    <asp:BoundField HeaderText="Otros" DataField="Otros"/> 
                                </Columns>
