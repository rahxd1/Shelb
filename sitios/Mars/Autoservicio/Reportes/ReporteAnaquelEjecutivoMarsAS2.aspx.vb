...
Partial Public Class ReporteAnaquelEjecutivoMarsAS2
    ...
    Sub CargarReporte()
        ...
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionMars.localSqlServer, _
                        "select H.orden,H.Ejecutivo, H.nombre_region,H.region_mars, " & _
                        "CASE when ((SUM(HDET.[1])+SUM(HDET.[15]))+(SUM(HDET.[5])+SUM(HDET.[16])))=0 then 0 else " & _
                        ...
                        " " + QuincenaSQL + Promotor + " " & _
                        " " + RegionSQL + CadenaSQL + " " & _
                        " " + EjecutivoSQL + " " & _
                        "GROUP BY H.orden,H.Ejecutivo, H.nombre_region,H.region_mars " & _
                        "ORDER BY H.Ejecutivo", Me.gridReporte)
        Else
    ...
    Private Sub gridReporte_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs) Handles gridReporte.RowDataBound
        If e.Row.RowType = DataControlRowType.DataRow Then
            For i = 0 To 6
                ...
                e.Row.Cells(i + 2).Text = e.Row.Cells(i + 2).Text & "%"
            Next
        End If
    ...
    Private Sub lnkVerTodo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkVerTodo.Click
        Response.Redirect("~/sitios/Mars/Autoservicio/Reportes/ReporteDetalleAnaquelEjecutivoMarsAS2.aspx?orden=" & cmbPeriodo.SelectedValue & "&region_mars=" & cmbEjecutivo.SelectedValue & "&id_quincena=" & cmbQuincena.SelectedValue & "&id_region=" & cmbRegion.SelectedValue & "")
    End Sub
