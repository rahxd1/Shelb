...
Partial Public Class ReportePreciosMarsAS2
    ...
    Sub CalculaModa()
        Dim QuincenaSQL, EjecutivoSQL, SupervisorSQL, PromotorSQL, RegionSQL, CadenaSQL, TiendaSQL As String
        ...
        If cmbQuincena.SelectedValue = "" Then
            QuincenaSQL = "" : Else
            QuincenaSQL = "AND H.id_quincena = '" & cmbQuincena.SelectedValue & "' " : End If
        ...
        If tabla.Rows.Count > 0 Then
            For i = 0 To tabla.Rows.Count - 1
                Campo(i) = "SELECT PROD.id_producto, precio as PrecioModa " & _
                    ...
                    "AND H.orden=" & cmbPeriodo.SelectedValue & " " & _
    ...
    Sub CargarReporte()
        ...
        If cmbPeriodo.SelectedValue <> "" Then
            ...
            CargaGrilla(ConexionMars.localSqlServer, _
                        "SELECT H.orden, PROD.nombre_producto, HDET.id_producto, " & _
                        ...
                        " " + EjecutivoSQL + SupervisorSQL + PromotorSQL + " " & _
                        " " + CadenaSQL + TiendaSQL + " " & _
                        "GROUP BY H.orden, PROD.nombre_producto, HDET.id_producto, Moda.PrecioModa " & _
