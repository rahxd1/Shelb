<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteHistoricoPreciosMarsAS2.aspx.vb" 
    Inherits="procomlcd.ReporteHistoricoPreciosMarsAS2"
        ...
        <div id="content-main-two-column">
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="cmbProducto" EventName="SelectedIndexChanged" />
                </Triggers>
            </asp:UpdatePanel>
        </div>
