<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteResultadosFeedbackMars.aspx.vb" 
    Inherits="procomlcd.ReporteResultadosFeedbackMars"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
                        Reporte resultados feedback</div>
                ...
                <tr>
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" Width="645px" 
                                ...
                                <Columns>
                                    <asp:BoundField HeaderText="Cuestionario" DataField="nombre_cuestionario"/>  
                                    <asp:BoundField HeaderText="" DataField="seccion"/>  
                                    <asp:BoundField HeaderText="Pregunta" DataField="id_pregunta"/> 
                                    <asp:BoundField HeaderText="Respuesta" DataField="nombre"/> 
                                    <asp:BoundField HeaderText="Cantidad promotores" DataField="cantidad"/> 
                                </Columns>
                        ...
                        <br>
                        <asp:GridView ID="gridComentarios" runat="server" AutoGenerateColumns="False" Width="645px" 
                                    ShowFooter="True" CssClass="grid-view">
                                <Columns>
                                    <asp:BoundField HeaderText="Comentarios" DataField="comentario"/> 
                                </Columns>
                            <FooterStyle CssClass="grid-footer" />
                            <EmptyDataTemplate>
