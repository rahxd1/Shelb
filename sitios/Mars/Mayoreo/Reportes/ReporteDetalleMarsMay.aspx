<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteDetalleMarsMay.aspx.vb" 
    Inherits="procomlcd.ReporteDetalleMarsMay"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
                        Reporte detalle por tienda</div>
                ...
                <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" Width="100%" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Semana" DataField="id_semana"/> 
