<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteRutasMarsVP.aspx.vb" 
    Inherits="procomlcd.ReporteRutasMarsVP"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
                        Reporte rutas verificadores mayoreo</div>
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" Width="645px" 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Verificador" DataField="id_usuario"/> 
                                    ...
                                    <asp:BoundField HeaderText="Lunes" DataField="dia1"/>  
                                    <asp:BoundField HeaderText="Martes" DataField="dia2"/>  
                                    <asp:BoundField HeaderText="Miércoles" DataField="dia3"/>  
                                    <asp:BoundField HeaderText="Jueves" DataField="dia4"/>  
                                </Columns>
