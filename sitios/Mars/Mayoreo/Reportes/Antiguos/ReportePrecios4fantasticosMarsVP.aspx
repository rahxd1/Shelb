<%@ Page Language="vb" 
    ...
    CodeBehind="ReportePrecios4fantasticosMarsVP.aspx.vb" 
    Inherits="procomlcd.ReportePrecios4fantasticosMarsVP"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
            Reporte precios 4 fantasticos</div>
        ...
        <div id="content-main-two-column">
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Label ID="lblPeriodoB" runat="server" Text="Periodo" CssClass="lbl" />
                    ...
                    <asp:Label ID="lblPeriodo2B" runat="server" Text="Periodo" CssClass="lbl" />
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                            DataKeyNames="folio_historial" Width="537px" ShowFooter="True" 
                            CssClass="grid-view">
                                <Columns>  
