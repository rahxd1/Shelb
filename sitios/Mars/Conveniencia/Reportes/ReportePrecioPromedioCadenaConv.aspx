<%@ Page Language="vb"
    ...
    CodeBehind="ReportePrecioPromedioCadenaConv.aspx.vb"
    Inherits="procomlcd.ReportePrecioPromedioCadenaConv" %>
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
            Reporte precio promedio por cadena</div>
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        CssClass="panel-grid">
                        <asp:GridView ID="gridReporte" CssClass="grid-view"  runat="server" Width="100%" ShowFooter="True">
                        <EmptyDataTemplate>
