<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteBitacoraMarsConv.aspx.vb" 
    Inherits="procomlcd.ReporteBitacoraMarsConv"
            ...
            <asp:UpdatePanel ID="updPnl" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel ID="pnlGrid" runat="server" ScrollBars="Both"
                        CssClass="panel-grid">
                        <asp:GridView ID="gridTotal" runat="server" 
                        ...
                        BorderStyle="Dashed" style="text-align: center" BorderWidth="2px">
                         <asp:GridView ID="gridDetalle" runat="server" 
                             ...
                             <Columns>
                                 ...
                                 <asp:BoundField DataField="Tipo" HeaderText="Reporte" />
