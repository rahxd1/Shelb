<%@ Page Language="vb" 
    ...
    CodeBehind="FormatoPreciosMarsConv.aspx.vb" 
    Inherits="procomlcd.FormatoPreciosMarsConv"
        ...
        <div id="content-main-two-column">
            ...
            <asp:Panel ID="pnlPropios" runat="server">
                <asp:GridView ID="gridProductos" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="id_producto" Width="99%" style="text-align: center" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Precio">
                            <ItemTemplate>
                                $<asp:TextBox ID="txtPrecio" runat="server" Width="50" 
                                    Text='<%# DataBinder.Eval(Container.DataItem, "precio") %>'></asp:TextBox>
                                <asp:RangeValidator id="rvaPrecio" runat="server" 
                                    ErrorMessage="El precio del producto indicado con un (*) supera el máximo permitido" Display="Dynamic" 
                                    MinimumValue="0" MaximumValue='<%# DataBinder.Eval(Container, "DataItem.precio_max")%>' Type="Double" ControlToValidate="txtPrecio" ValidationGroup="Mars" >*</asp:RangeValidator>
                                 <asp:RequiredFieldValidator ID="rfvPrecio" runat="server" 
                                    ControlToValidate="txtPrecio" 
                                    ErrorMessage="Completa el precio del producto indicado con un (*)" 
                               ...
                               <tr>
                                   <td style="text-align: center; height: 31px; " colspan="2">
                                       ...
                                       <asp:ValidationSummary ID="vsMars" runat="server" 
                                           ValidationGroup="Mars" ShowMessageBox="True" ShowSummary="False" 
                                           HeaderText="Completa la información" />
