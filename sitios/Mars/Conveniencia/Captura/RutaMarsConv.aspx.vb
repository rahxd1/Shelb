...
Partial Public Class RutaMarsConv
    Inherits System.Web.UI.Page

    Dim CapturaAbierta As Integer
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If tipo_usuario = 1 Or tipo_usuario = 2 Then
                ...
                Combo.LlenaDrop(ConexionMars.localSqlServer, "SELECT DISTINCT TOP 4 * FROM Periodos_Nuevo " & _
            ...
            If Consulta = 1 Then
                ...
                Combo.LlenaDrop(ConexionMars.localSqlServer, "SELECT distinct id_usuario " & _
                                "FROM Conv_CatRutas ORDER BY id_usuario", "id_usuario", "id_usuario", cmbPromotor)
                ''//Cargar Periodo Promotor Supervisor
    ...
    Sub CargarRegion()
        Combo.LlenaDrop(ConexionMars.localSqlServer, "SELECT DISTINCT REG.nombre_region, REG.id_region " & _
    ...
    Sub CargarRuta()
        ...
        If tipo_usuario <> 1 Then
            SQLCargaRuta = "execute Conv_Cargar_Ruta " & cmbPeriodo.SelectedValue & ",'" & cmbPromotor.SelectedValue & "'" : Else
            SQLCargaRuta = "execute Conv_Cargar_Ruta " & cmbPeriodo.SelectedValue & ",'" & HttpContext.Current.User.Identity.Name & "'" : End If
    ...
    Protected Sub cmbRegion_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles cmbRegion.SelectedIndexChanged
        If cmbRegion.SelectedValue <> 0 Then
            Combo.LlenaDrop(ConexionMars.localSqlServer, "select distinct REG.nombre_region, RUT.id_usuario " & _
                        ...
                        "WHERE REG.id_region = '" & cmbRegion.SelectedValue & "'" & _
