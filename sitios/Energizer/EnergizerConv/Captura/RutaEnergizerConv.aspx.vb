...
Partial Public Class RutaEnergizerConv
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not Page.IsPostBack Then
            ...
            If tipo_usuario <> 1 Then
                ...
                Combo.LlenaDrop(ConexionEnergizer.localSqlServer, "SELECT * FROM Energizer_Conv_Periodos ORDER BY id_periodo DESC", "nombre_periodo", "id_periodo", cmbPeriodo)
                Region()
            Else
                ''//Cargar periodo promotor
                Combo.LlenaDrop(ConexionEnergizer.localSqlServer, "SELECT TOP 4 * FROM Energizer_Conv_Periodos ORDER BY id_periodo DESC", "nombre_periodo", "id_periodo", cmbPeriodo)
            End If
    ...
    Sub CargarRuta()
        ...
        CargaGrilla(ConexionEnergizer.localSqlServer, _
                    "execute pcdt_Energizer_Conv_Cargar_Ruta " & cmbPeriodo.SelectedValue & ",'" & Usuario & "'", _
                    Me.gridRutas)
    End Sub

    Protected Sub cmbRegion_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles cmbRegion.SelectedIndexChanged
        If cmbRegion.SelectedValue <> 0 Then
            Combo.LlenaDrop(ConexionEnergizer.localSqlServer, "SELECT DISTINCT RE.id_usuario FROM Energizer_Conv_Rutas_Eventos AS RE " & _
    ...
    Private Sub PeriodoActivo()
        ...
        cnn.Open()
        Dim SQL As New SqlCommand("SELECT * FROM Energizer_Conv_Periodos where id_periodo =" & cmbPeriodo.Text & "", cnn)
