<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteMaterialesCompEnergizerConv.aspx.vb" 
    Inherits="procomlcd.ReporteMaterialesCompEnergizerConv"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
            Reporte materiales por tienda Energizer vs. Competencia</div>
                    ...
                    <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                        Width="100%" ShowFooter="True" CssClass="grid-view">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Materiales Energizer" DataField="MaterialesEnergizer"/>  
                                <asp:BoundField HeaderText="Materiales Competencia" DataField="MaterialesCompetencia"/>  
                            </Columns>
