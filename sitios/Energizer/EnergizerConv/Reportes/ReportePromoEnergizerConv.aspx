<%@ Page Language="vb" 
    ...
    CodeBehind="ReportePromoEnergizerConv.aspx.vb" 
    Inherits="procomlcd.ReportePromoEnergizerConv"
                    ...
                    <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                        Width="100%" ShowFooter="True" CssClass="grid-view">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Promocionales Eveready" DataField="promo_e"/>  
                                <asp:BoundField HeaderText="Promocionales Duracell" DataField="promo_d"/>  
                            </Columns>
