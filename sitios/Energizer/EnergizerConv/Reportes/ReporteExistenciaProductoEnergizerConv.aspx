<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteExistenciaProductoEnergizerConv.aspx.vb" 
    Inherits="procomlcd.ReporteExistenciaProductoEnergizerConv"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
            Reporte existencias por producto por tienda</div>
                    ...
                    <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                        Width="100%" ShowFooter="True" CssClass="grid-view">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Existencias" DataField="existencia"/>  
                            </Columns>
