<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteExistenciaCompEnergizerConv.aspx.vb" 
    Inherits="procomlcd.ReporteExistenciaCompEnergizerConv"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
            Reporte existencias por tienda Energizer vs. Competencia</div>
                    ...
                    <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                        Width="100%" ShowFooter="True" CssClass="grid-view">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Existencias Energizer" DataField="ExistenciasTotales"/>  
                                <asp:BoundField HeaderText="Existencias Competencia" DataField="ExistenciasCompetencia"/>  
                            </Columns>
