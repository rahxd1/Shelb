...
Partial Public Class ReportePromoEnergizerConv
    ...
    Sub CargarReporte()
        ...
        CargaGrilla(ConexionEnergizer.localSqlServer, _
                    "SELECT DISTINCT PER.nombre_periodo, REG.nombre_region, H.id_usuario, CAD.nombre_cadena, Ti.nombre, H.promo_e,H.promo_d " & _
                    ...
                    "INNER JOIN Regiones as REG ON REG.id_region= TI.id_region  " & _
                    "WHERE H.promo_e<>'' OR H.promo_d<>'' " & _
                    " " + PeriodoSQL + " " & _
                    " " + RegionSQL + " " & _
                    " " + PromotorSQL + " " & _
                    " " + TiendaSQL + " " & _
