...
Partial Public Class ReporteExistenciaProductoEnergizerConv
    ...
    Sub SQLCombo()
        If cmbPeriodo.SelectedValue = "" Then
            PeriodoSel = "":Else
            PeriodoSel = " AND RE.id_periodo=" & cmbPeriodo.SelectedValue & " " : End If
    ...
    Sub CargarReporte()
        ...
        CargaGrilla(ConexionEnergizer.localSqlServer, _
                    "SELECT DISTINCT PER.nombre_periodo, REG.nombre_region, H.id_usuario, CAD.nombre_cadena, Ti.nombre,PROD.nombre_producto, HDET.existencia " & _
