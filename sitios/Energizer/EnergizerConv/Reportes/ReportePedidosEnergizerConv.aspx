<%@ Page Language="vb" 
    ...
    CodeBehind="ReportePedidosEnergizerConv.aspx.vb" 
    Inherits="procomlcd.ReportePedidosEnergizerConv"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
            Reporte pedidos por tienda</div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="width: 96px">Promotor</td>
                    ...
                    <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                        Width="100%" ShowFooter="True" CssClass="grid-view">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Pedidos" DataField="PedidosTotales"/>  
                            </Columns>
