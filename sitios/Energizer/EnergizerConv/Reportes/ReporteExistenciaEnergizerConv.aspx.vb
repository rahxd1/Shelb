...
Partial Public Class ReporteExistenciaEnergizerConv
    ...
    Sub CargarReporte()
        ...
        CargaGrilla(ConexionEnergizer.localSqlServer, _
                    "SELECT DISTINCT PER.nombre_periodo, REG.nombre_region, H.id_usuario, CAD.nombre_cadena, Ti.nombre, sum(HDET.existencia) as ExistenciasTotales " & _
                    ...
                    "WHERE HDET.existencia <>'0' " & _
                    "AND PROD.tipo_producto=1 " & _
                    " " + PeriodoSQL + " " & _
                    " " + RegionSQL + " " & _
                    " " + PromotorSQL + " " & _
                    " " + TiendaSQL + " " & _
