<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteMaterialesEnergizerConv.aspx.vb" 
    Inherits="procomlcd.ReporteMaterialesEnergizerConv"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
            Reporte materiales Energizer</div>
                    ...
                    <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                        Width="100%" ShowFooter="True" CssClass="grid-view">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Cantidad de Materiales Energizer" DataField="cantidad_energizer"/>  
                            </Columns>
