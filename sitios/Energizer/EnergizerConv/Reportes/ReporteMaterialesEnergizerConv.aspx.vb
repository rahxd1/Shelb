...
Partial Public Class ReporteMaterialesEnergizerConv
    ...
    Sub CargarReporte()
        ...
        If Not RegionSel = "" Then
            RegionSQL = "AND REG.id_region=" & RegionSel & " " : Else
            RegionSQL = "" : End If

        If Not PromotorSel = "" Then
            PromotorSQL = "AND H.id_usuario='" & PromotorSel & "' " : Else
            PromotorSQL = "" : End If
        ...
        CargaGrilla(ConexionEnergizer.localSqlServer, _
                    "SELECT DISTINCT PER.nombre_periodo, REG.nombre_region, H.id_usuario, CAD.nombre_cadena, Ti.nombre, H.cantidad_energizer " & _
