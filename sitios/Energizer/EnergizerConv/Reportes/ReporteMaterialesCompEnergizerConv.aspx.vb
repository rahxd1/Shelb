...
Partial Public Class ReporteMaterialesCompEnergizerConv
    ...
    Sub CargarReporte()
        ...
        CargaGrilla(ConexionEnergizer.localSqlServer, _
                    ...
                    "(SELECT H.cantidad_energizer as MaterialesEnergizer, H.folio_historial " & _
                    "From Energizer_Conv_Historial as H) AS Energizer, " & _
                    "(SELECT H.cantidad_otros as MaterialesCompetencia, H.folio_historial " & _
                    "From Energizer_Conv_Historial as H) as Competencia " & _
