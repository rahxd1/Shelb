...
Partial Public Class ReporteOfertacionesCompetencia
    ...
    Sub CargarReporte()
        Using cnn As New SqlConnection(ConexionEnergizer.localSqlServer)
            ...
            Dim sql As String = "SELECT REG.nombre_region, CAD.nombre_cadena, TI.nombre, H.ofertaciones_competencia " & _
                                ...
                                "AND H.ofertaciones_competencia<>'' " & _
                                " " + RegionSQL + " " & _
                                " " + PromotorSQL + " " & _
                                " " + CadenaSQL + " " & _
                                " " + TiendaSQL + " " & _
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Reporte Ofertaciones competencia" + cmbPeriodo.SelectedItem.ToString + ".xls")
