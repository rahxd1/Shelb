...
Partial Public Class ReporteProductosSchick
    ...
    Sub CargarReporte()
        Using cnn As New SqlConnection(ConexionEnergizer.localSqlServer)
            ...
            Dim sql As String = "SELECT PROM.id_producto,PROM.nombre_producto, sum(ISNULL(HDET.cantidad,0)) as Totales  " & _
                                "FROM Schick_Productos AS PROM " & _
                                "FULL JOIN ( SELECT HDET.id_producto, HDET.cantidad FROM Schick_Productos_Historial_Det AS HDET " & _
                                "INNER JOIN Schick_Historial AS H ON H.folio_historial = HDET.folio_historial " & _
                                ...
                                " " + CadenaSQL + " " & _
                                " " + TiendaSQL + " " & _
                                " )as HDET ON PROM.id_producto = HDET.id_producto " & _
                                "GROUP BY PROM.id_producto, PROM.nombre_producto " & _
                                "ORDER BY PROM.id_producto, PROM.nombre_producto "
            ...
            adapter.Fill(dataset, "nombre_producto")
            ...
            strXML.Append("<chart caption='CANTIDAD DE PRODUCTOS VENDIDOS' showborder='0' bgcolor='FFFFFF' bgalpha='100' subcaption='' xAxisName='Productos' yAxisName='Cantidad' rotateLabels='1'  placeValuesInside='1' rotateValues='1' >")

            For i = 0 To tabla.Rows.Count - 1
                Dim Totales As Double
                Totales = FormatNumber(tabla.Rows(i)("totales"), 2)
                strXML.Append("<set label='" & tabla.Rows(i)("nombre_producto") & "' value='" & Totales & "' />")
            Next i
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Reporte Productos Vendidos" + cmbPeriodo.SelectedItem.ToString + ".xls")
