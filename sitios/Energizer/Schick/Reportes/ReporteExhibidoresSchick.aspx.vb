...
Partial Public Class ReporteExhibidoresSchick
    ...
    Sub CargarReporte()
        Using cnn As New SqlConnection(ConexionEnergizer.localSqlServer)
            ...
            Dim sql As String = "SELECT DISTINCT nombre_region as 'Región',id_usuario as 'ID usuario',nombre_cadena as 'Cadena', nombre as Tienda, " & _
                        "[600]as '20 GANCHOS',[601]as 'SIDEKICK',[602]as 'TIRAS',[603]as 'MODULARES',[604]as 'CABECERAS' " & _
                        ...
                        "FULL JOIN Schick_Exhibidores_Historial_Det as HDET ON H.folio_historial= HDET.folio_historial " & _
                        ...
                        "FOR id_exhibidor IN ([600],[601],[602],[603],[604])) AS PivotTable " & _
                        "ORDER BY nombre_region,nombre_cadena,nombre"
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=ReporteExhibidores Schick" + cmbPeriodo.SelectedItem.ToString + ".xls")
