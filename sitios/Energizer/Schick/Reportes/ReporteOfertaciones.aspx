<%@ Page Language="vb"
    ...
    AutoEventWireup="false" CodeBehind="ReporteOfertaciones.aspx.vb" 
    Inherits="procomlcd.ReporteOfertacionesCompetencia"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
            Reporte Ofertaciones Competencia</div>
                    ...
                    <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                        ...
                        <RowStyle BackColor="#EEEEEE" ForeColor="Black" />
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Ofertaciones" DataField="ofertaciones_competencia"/>
                            </Columns>
