<%@ Page Language="vb"
    ...
    CodeBehind="ReporteProductosSchick.aspx.vb" 
    Inherits="procomlcd.ReporteProductosSchick" %>
 
 <asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1Schick" runat="Server">

<!--titulo-pagina-->
        <div id="titulo-pagina">
            Reporte Productos Vendidos</div>
                ...
                <ContentTemplate>
                    ...
                    <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                        ...
                        <RowStyle BackColor="#EEEEEE" ForeColor="Black" />
                            <Columns>
                                <asp:BoundField HeaderText="Productos" DataField="nombre_producto"/> 
