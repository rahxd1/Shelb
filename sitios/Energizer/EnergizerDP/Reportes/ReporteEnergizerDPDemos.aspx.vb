...
Partial Public Class ReporteEnergizerDPDemos
    ...
    Sub CargarReporte()
        ...
        Dim SQL As String = "SELECT COMP.nombre_competencia, avg(HExh.demos) as Totales " & _
                        ...
                        "INNER JOIN Cadenas_Tiendas as CAD ON TI.id_cadena= CAD.id_cadena " & _
                        "WHERE COMP.id_competencia <> '1' AND HExh.demos <>'0' " & _
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=Reporte Demos Competencia " + cmbPeriodo.SelectedItem.ToString() + ".xls")
