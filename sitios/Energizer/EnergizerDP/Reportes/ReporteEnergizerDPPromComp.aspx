<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteEnergizerDPPromComp.aspx.vb" 
    Inherits="procomlcd.ReporteEnergizerDPPromComp"
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
            Reporte promocionales competencia</div>
                ...
                <ContentTemplate>
                    <table style="width: 100%">
                        <tr><td style="width: 96px">&nbsp;</td>
                            ...
                            <td style="text-align: right"><img alt="Regresa" src="../../../../Img/arrow.gif" /><asp:HyperLink ID="lnkRegresar" runat="server" NavigateUrl="~/sitios/Energizer/EnergizerDP/Reportes/ReportesEnergizerDP.aspx">Regresar</asp:HyperLink></td>
                        </tr>
                    ...
                    <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                        Width="100%" ShowFooter="True" CssClass="grid-view">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Competencia" DataField="nombre_competencia"/> 
                                <asp:BoundField HeaderText="Promocionales" DataField="tipo_promocionales"/>  
                            </Columns>
