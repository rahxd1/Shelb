<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteEnergizerDPExhibidores.aspx.vb" 
    Inherits="procomlcd.ReporteEnergizerDPExhibidores" 
...
<!--titulo-pagina-->
        <div id="titulo-pagina">
            Reporte promedio exhibidores competencia</div>
        ...
        <div id="content-main-two-column">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server"> 
                <ContentTemplate>
                    ...
                    <asp:Button ID="btnExcel" runat="server" Text="Exportar a Excel" Enabled="False" />
                    <br />
                    <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                        Width="100%" ShowFooter="True" CssClass="grid-view">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Exhibidores" DataField="totales"/> 
                            </Columns>
