...
Partial Public Class ReporteComentariosHB
    ...
    Sub CargarReporte()
        ...
        CargaGrilla(ConexionEnergizer.localSqlServer, _
                    "SELECT REG.nombre_region, CAD.nombre_cadena, TI.nombre, H.comentarios_competencia " & _
                    "FROM HawaiianBanana_Historial as H " & _
                    "INNER JOIN HawaiianBanana_Tiendas as TI ON TI.id_tienda= H.id_tienda  " & _
                    "INNER JOIN Regiones as REG ON REG.id_region= TI.id_region  " & _
                    "INNER JOIN Cadenas_Tiendas as CAD ON TI.id_cadena= CAD.id_cadena " & _
                    "WHERE H.id_marca = " & cmbMarca.SelectedValue.ToString() & " " & _
    ...
    Protected Sub lnkExportar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkExportar.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=ReporteComentarios" + cmbPeriodo.SelectedItem.ToString + ".xls")
