<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteBitacoraHB.aspx.vb" 
    Inherits="procomlcd.ReporteBitacoraHB"
                    ...
                    <ContentTemplate>
                            ...
                            <tr><td style="width: 96px">&nbsp;</td>
                                ...
                                <td style="text-align: right">
                                    <img alt="" src="../../../../Img/arrow.gif" /><asp:HyperLink ID="lnkRegresar" runat="server" 
                                            NavigateUrl="~/sitios/Energizer/Hawaiian/Reportes/ReportesHawaiianBanana.aspx">Regresar</asp:HyperLink></td>
                            </tr>
                        ...
                        <asp:GridView ID="gridReporte" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Capturas1" HeaderText="Hawaiian" />
                                <asp:BoundField DataField="Capturas2" HeaderText="Banana" />
                                <asp:BoundField DataField="CapturasTotales" HeaderText="Capturas totales" />
                                <asp:BoundField DataField="Porcentaje" HeaderText="% Captura" />
                            </Columns>
                        ...
                        <asp:GridView ID="gridDetalle" runat="server" 
                             ...
                             <Columns>
                                 ...
                                 <asp:BoundField DataField="estatus1" HeaderText="Hawaiian" />
                                 <asp:BoundField DataField="estatus2" HeaderText="Banana" />
                             </Columns>
                             <FooterStyle BackColor="#CCCCCC" ForeColor="Black" />
                             <PagerStyle BackColor="#999999" ForeColor="Black" HorizontalAlign="Center" />
                             <SelectedRowStyle BackColor="#008A8C" Font-Bold="True" ForeColor="White" />
