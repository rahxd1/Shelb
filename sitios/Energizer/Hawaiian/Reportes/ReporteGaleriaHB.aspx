<%@ Page Language="vb" 
    ...
    CodeBehind="ReporteGaleriaHB.aspx.vb" 
    Inherits="procomlcd.ReporteGaleriaHB"
                        ...
                        <tr>
                            <td style="height: 19px; text-align: right;" colspan="2">
                                ...
                                <asp:HyperLink ID="lnkRegresar" runat="server" 
                                    NavigateUrl="~/sitios/Energizer/Hawaiian/Reportes/ReportesHawaiianBanana.aspx">Regresar</asp:HyperLink>
                            </td>
                        </tr>
                        <tr>
