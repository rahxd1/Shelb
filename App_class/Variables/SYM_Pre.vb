...
Module SYMPre
    Public Sub SQLsComboPrecios(ByVal cmbPeriodo As String, ByVal cmbRegion As String, _
        ...
        SYM_Pre.PeriodoSQLCmb = "SELECT id_periodo, nombre_periodo " & _
                         "FROM SYM_Precios_Periodos " & _
                         " ORDER BY fecha_inicio DESC"

        SYM_Pre.RegionSQLCmb = "SELECT DISTINCT REG.nombre_region, REG.id_region " & _
                    "FROM SYM_Regiones as REG " & _
                    "WHERE REG.id_region<>0 " & _
                    " ORDER BY REG.nombre_region"

        SYM_Pre.PlazasSQLcmb = "SELECT DISTINCT US.plaza " & _
        ...
        SYM_Pre.CadenaSQLCmb = "SELECT DISTINCT CAD.id_cadena, CAD.nombre_cadena " & _
        ...
        SYM_Pre.PromotorSQLCmb = "SELECT DISTINCT H.id_usuario " & _
                    "FROM SYM_Precios_Historial as H " & _
                    "INNER JOIN Usuarios as US ON US.id_usuario=H.id_usuario " & _
